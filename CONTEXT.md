...
9. The same product-owned Agent conversation continues in the product workbench beside the editable workflow. The Agent inspects, explains, applies one reversible ChangeSet or proposes a multi-node ChangeSet, and may request runs.
