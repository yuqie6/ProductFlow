...
本文件矩阵与批次可执行；**R1 / MP-A / MP-B 已过；MP-C B0–B4 + 价格目录骨架 + 图会话入口单价展示 + unknown 到期策略已交付；总纲 R5 未通过；≠ 第二外部商产品上线；≠ 真实支付；≠ MP-D。**
