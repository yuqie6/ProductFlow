...
- 成片 OCR B0 已交付（字形模板+残余墨迹；live 视觉 opt-in）；采用路径默认消费与开放词表/CJK 覆盖仍另发；≠R3。
