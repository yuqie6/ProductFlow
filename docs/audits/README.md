...
|---|---|---|---|---|
| 工作流体验 | [canvas-test-system.md](canvas-test-system.md) | 开工 | 商家编辑、运行与结果使用链的业务正确性；当前交付聚焦文稿权威与检查器草稿保存 | C4/AR-01 已验收；C3 整图 undo 已归档；剩余浏览器证据见 canvas-c4-remainder，不重复派版本语义任务 |
