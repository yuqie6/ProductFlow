...
[`ROADMAP.md`](ROADMAP.md) 是可自托管 SaaS 的产品方向与正式版总纲（同站多商家账号，每个普通账号自有一个商家，管理员管理各商家的商品），拥有竞品吸收、未来体验、隔离与经营要求、阶段出口和未决问题。其中现场实现只用于说明决策依据，不替代当前能力文档。已接线的能力写在 PRD / ARCHITECTURE / USER_GUIDE。仓库不再维护独立的 `specs/` 树。
