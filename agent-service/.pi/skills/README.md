...
技能是带 frontmatter 的 Markdown。目录提示词只暴露 name、description、triggers、guards_tools、scope；正文按需用 `load_productflow_skill` 加载。
...
| `guards_tools` | 是 | 本技能守护的工具名，必须存在于 `tool-manifest.ts` |
