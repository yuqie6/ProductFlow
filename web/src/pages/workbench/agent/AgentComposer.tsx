  ...
  return (
    <div data-agent-composer className="shrink-0 border-t border-border-l1 bg-surface-base/95 px-3 py-3 backdrop-blur sm:px-4 sm:py-4">
      <div className="mx-auto w-full max-w-[48rem]">
        ...
        <div
          className={`overflow-hidden rounded-surface border bg-surface-raised shadow-elev-2 transition-[border-color,box-shadow] duration-fast focus-within:border-accent/70 focus-within:shadow-elev-3 motion-reduce:transition-none ${dragging ? "border-accent/80" : "border-border-l3"
            }`}
          onDragOver={(event) => {
            if (!onUploadFiles) {
              return;
