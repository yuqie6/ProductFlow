...
const product: ProductSummary = {
  ...
  cover_image_download_url: "/api/v2/product-image-assets/asset-1/download",
  cover_image_preview_url: "/api/v2/product-image-assets/asset-1/download?variant=preview",
  cover_image_thumbnail_url: "/api/v2/product-image-assets/asset-1/download?variant=thumbnail",
