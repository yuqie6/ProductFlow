          ...
          blocks: [
            ...
            },
            {
              ...
              items: [
                ...
                "把素材拖到画布空白处会新建已绑定、未连线的图片节点；拖到聚合口会连参考边。",
