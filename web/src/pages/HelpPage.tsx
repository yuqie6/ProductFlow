          ...
          blocks: [
            {
              ...
              items: [
                ...
                "图片生成：查看结果及本节点历史版本；比例、清晰度和高级设置只显示当前适配器支持的选项。补充要求不能取消共享约束。未覆盖字段继承方案；修改本图只保存修改项，恢复继承后跟随方案新值。文字可在本图独立设置。运行只出图，不重写共享文稿。导出折叠区单独设置交付尺寸、格式和适配方式，生成交付图不调用模型。",
              ],
            },
          ],
        },
