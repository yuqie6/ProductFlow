...
is_repo_dev_process() {
  ...
  case "${cmd}" in
    *productflow_backend.workers* | *productflow_backend.main:app* | *productflow_backend.commands.run_async_dispatcher* | *"pnpm --dir agent-service"* | *"pnpm --dir web"* | *" --dir web dev"* | *"/node_modules/.bin/vite"*)
      return 0
      ;;
  esac
  return 1
